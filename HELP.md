...
* The original package name 'com.victornastase.testcontainer-poc' is invalid and this project uses 'com.victornastase.testcontainerpoc' instead.
...
```
$ docker run --rm -p 8080:8080 testcontainer-poc:0.0.1-SNAPSHOT
```
